...
public class SuscripcionService {
    ...
    public final Suscripcion crearSuscripcion(String plan){

        Optional<Plan> planDeseado = planService.mostrarPlan(plan);
        if(planDeseado.isEmpty()) throw new NoSuchElementException("El plan solicitado no existe");
        final Suscripcion suscripcion = new Suscripcion(planDeseado.get().getID());
